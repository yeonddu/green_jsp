	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(action == null) {
				...
				pw.print("<script>" + "alert('새글을 추가했습니다.');" + "location.href='" + request.getContextPath() + "/board3/listArticles.do';" + "</script>");
				return;
			 ...
			 if (imageFileName != null && imageFileName.length() != 0) {
				...
				PrintWriter pw = response.getWriter();
				pw.print("<script>" + "alert('글을 수정했습니다.');" + " location.href='"+request.getContextPath() + "/board3/viewArticle.do?articleNO="+articleNO+";"+"</script>");
				return;
