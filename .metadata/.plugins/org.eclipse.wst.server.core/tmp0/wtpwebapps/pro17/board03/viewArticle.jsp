...
<script type="text/javascript">
	function backToList(obj) {
     ...
     function fn_modify_article(obj){
         obj.action="${contextPath}/board3/modArticle.do";
         obj.submit();
     }
...
<body>
	...
	<tr id="tr_btn_modify">
		<td colspan="2" align="center">
			<input type="button" name="mod_btn" value="수정반영하기" onClick="fn_modify_article(frmArticle)" >
	...
	<tr id="tr_btn">
		<td colspan="2" align="center">
			...
			<input type="button" value="삭제하기" onClick="fn_remove_article('${contextPath }/board3/removeArticle.do',${article.articleNO })">
			<input type="button" value="리스트로 돌아가기" onClick="backToList(this.form)">
			<input type="button" value="답글쓰기" onClick="fn_reply_form('${contextPath}/board3/replyForm.do',${article.articleNO })">
		</td>
	</tr>
	</table>
	</form>
