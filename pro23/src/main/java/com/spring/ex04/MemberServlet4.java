...
public class MemberServlet4 extends HttpServlet {
	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action == null || action.equals("listMembers")) {
			...
			memList.add(new MemberVO("s1","1234","foreachInsert","m1@test.com"));
			memList.add(new MemberVO("s2","1234","foreachInsert","m2@test.com"));
			memList.add(new MemberVO("s3","1234","foreachInsert","m3@test.com"));
